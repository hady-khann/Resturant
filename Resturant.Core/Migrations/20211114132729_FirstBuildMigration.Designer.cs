...
namespace Resturant.Core.Migrations
{
    ...
    [Migration("20211114132729_FirstBuildMigration")]
    partial class FirstBuildMigration
    {
            ...
            modelBuilder.Entity("Resturant.Core.Models.Resturant", b =>
                {
                    ...
                    b.HasIndex("ResturantType");

                    b.ToTable("Resturant");
                });

            modelBuilder.Entity("Resturant.Core.Models.ResturantInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Resturant.Core.Models.ResturantInfo", b =>
                {
                    b.HasOne("Resturant.Core.Models.Resturant", "Resturant")
                        .WithMany("ResturantInfos")
                        .HasForeignKey("ResturantId")
                        .HasConstraintName("FK_ResturantInfo_Resturant")
                        .IsRequired();
